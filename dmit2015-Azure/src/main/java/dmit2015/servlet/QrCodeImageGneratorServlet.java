...
@WebServlet(name = "QrCodeImageGneratorServlet", value = "/QrCodeImageGneratorServlet")
public class QrCodeImageGneratorServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int imageSzie = (imageSizeString == null || imageSizeString.isBlank()) ? 114 : Integer.parseInt(imageSizeString);
        if(urlString == null|| urlString.isBlank()){
            ...
            try {
                byte[] imageContent = generateQrCodeImage(urlString,imageSzie);
