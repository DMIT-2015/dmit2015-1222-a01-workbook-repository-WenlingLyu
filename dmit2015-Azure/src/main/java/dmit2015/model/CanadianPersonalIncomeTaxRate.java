...
public class CanadianPersonalIncomeTaxRate {
    ...
    private Double endingIncome;  // Double means this filed can not have value -- nullable
    ...
    public static Optional<CanadianPersonalIncomeTaxRate> parseCsv(String line){
        ...
        * */
        ...
        if(tokens.length != 9) throw new RuntimeException("Line does not contain exactly 9 values");
...
//        double endingIncome = tokens[5].isBlank() ? null : Double.valueOf(tokens[5]);   // when convert a nullable columns
